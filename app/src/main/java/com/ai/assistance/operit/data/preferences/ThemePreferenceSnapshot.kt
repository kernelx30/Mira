...
data class ThemePreferenceSnapshot(
    ...
    val bubbleUserCornerRadius: Float,
    val bubbleAiCornerRadius: Float,
    val bubbleUserMaxWidthRatio: Float,
    val bubbleAiMaxWidthRatio: Float,
    val bubbleMessageVerticalPadding: Float,
    val bubbleShadowElevation: Float,
