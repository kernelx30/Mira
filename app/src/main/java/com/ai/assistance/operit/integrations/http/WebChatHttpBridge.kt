    ...
    private suspend fun buildThemeSnapshot(
        ...
        return WebThemeSnapshot(
            ...
            bubble = WebBubbleTheme(
                ...
                userCornerRadius = snapshot.bubbleUserCornerRadius,
                assistantCornerRadius = snapshot.bubbleAiCornerRadius,
                userMaxWidthRatio = snapshot.bubbleUserMaxWidthRatio,
                assistantMaxWidthRatio = snapshot.bubbleAiMaxWidthRatio,
                messageVerticalPadding = snapshot.bubbleMessageVerticalPadding,
                shadowElevation = snapshot.bubbleShadowElevation,
