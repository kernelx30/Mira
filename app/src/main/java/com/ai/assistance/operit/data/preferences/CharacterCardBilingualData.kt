...
object CharacterCardBilingualData {
    ...
    fun getDefaultDescription(context: Context): String {
        return DefaultCompanionPreset.content(isChineseLocale(context)).description
    }
    ...
    fun getDefaultCharacterSetting(context: Context): String {
        return DefaultCompanionPreset.content(isChineseLocale(context)).characterSetting
    }

    fun getDefaultOpeningStatement(context: Context): String {
        return DefaultCompanionPreset.content(isChineseLocale(context)).openingStatement
    }
    ...
    fun getDefaultOtherContentChat(context: Context): String {
        return DefaultCompanionPreset.content(isChineseLocale(context)).otherContentChat
    }
    ...
    fun getDefaultOtherContentVoice(context: Context): String {
        return DefaultCompanionPreset.content(isChineseLocale(context)).otherContentVoice
    }
